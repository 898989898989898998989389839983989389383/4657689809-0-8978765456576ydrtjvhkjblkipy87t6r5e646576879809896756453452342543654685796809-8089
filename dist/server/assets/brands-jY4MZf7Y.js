...
const brandsList = [{
  ...
  name: "Finolex",
  desc: "Wires, cables, and electrical conduits",
  image: "/brands/finolex.svg"
}, {
  name: "Polycab",
  desc: "Wires, cables, fans, and switches",
  image: "/brands/polycab.svg"
}, {
  name: "Syska",
...
function BrandsPage() {
  return /* @__PURE__ */ jsx("main", { className: "bg-surface py-14 lg:py-20", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-4 lg:px-8", children: [
    /* @__PURE__ */ jsx(SectionHeading, { badge: "Our Brands", title: "Authorized Brands We Carry", description: "We are connected with more than 150 trusted electrical brands. Every product is 100% genuine with full warranty." }),
    /* @__PURE__ */ jsx("div", { className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-3", children: brandsList.map((b, index) => /* @__PURE__ */ jsxs("div", { className: "brand-card animate-fade-up rounded-2xl border border-border bg-card p-6 shadow-card", style: {
      animationDelay: `${index * 90}ms`
    }, children: [
      /* @__PURE__ */ jsx("div", { className: "brand-logo-shell mb-4 flex h-24 items-center justify-center overflow-hidden rounded-2xl border border-border/60 bg-white p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]", children: /* @__PURE__ */ jsx("img", { src: b.image, alt: `${b.name} logo`, className: "brand-logo h-full w-full object-contain", onError: (e) => {
      ...
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-foreground", children: b.name }),
