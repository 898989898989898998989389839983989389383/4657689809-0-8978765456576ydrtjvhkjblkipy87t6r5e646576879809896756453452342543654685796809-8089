...
import { b as buildFaqJsonLd } from "./router-DBylJ1xW.js";
...
function FAQItem({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border bg-card shadow-card", children: [
    /* @__PURE__ */ jsxs("button", { onClick: () => setOpen(!open), className: "flex w-full items-center justify-between gap-4 p-5 text-left", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsx(HelpCircle, { className: "mt-0.5 h-5 w-5 shrink-0 text-primary" }),
    ...
    open && /* @__PURE__ */ jsx("div", { className: "border-t border-border px-5 pb-5 pt-3", children: /* @__PURE__ */ jsx("p", { className: "pl-8 text-sm text-muted-foreground", children: a }) })
  ] });
}
function FAQPage() {
  const allFaqItems = faqGroups.flatMap((group) => group.items);
  return /* @__PURE__ */ jsxs("main", { className: "bg-surface py-14 lg:py-20", children: [
    /* @__PURE__ */ jsx("script", { type: "application/ld+json", dangerouslySetInnerHTML: {
      __html: JSON.stringify(buildFaqJsonLd(allFaqItems))
    } }),
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl px-4 lg:px-8", children: [
      /* @__PURE__ */ jsx(SectionHeading, { badge: "FAQ", title: "Frequently Asked Questions", description: "Find answers to common questions about our products, services, and wholesale supply." }),
      faqGroups.map((group) => /* @__PURE__ */ jsxs("div", { className: "mb-10", children: [
        /* @__PURE__ */ jsx("h3", { className: "mb-4 text-lg font-semibold text-foreground", children: group.category }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3", children: group.items.map((item) => /* @__PURE__ */ jsx(FAQItem, { q: item.q, a: item.a }, item.q)) })
      ] }, group.category))
    ] })
  ] });
}
